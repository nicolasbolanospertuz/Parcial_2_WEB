...
class MySpaces extends Component {
  ...
  componentDidMount() {
    if (localStorage.getItem("spacesData") == null && navigator.onLine) {
      fetch(
  ...
  renderRooms(roomid) {
    if (roomid !== -1) this.setState({ rooms: <MyRoom roomId={roomid} /> });
        ...
        <Card.Img
          ...
          src={
            el.type === "house"
              ...
              : "https://foxonline.temple.edu/animations/sites/animations/files/2021-03/isometric-office-building.png"
          }
        />
        <Card.Body>
